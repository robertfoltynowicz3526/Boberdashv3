...
export const renderMonthStats = (host, stats = {}) => {
  ...
  host.innerHTML = `<div class="metrics-grid">
    ...
    <div class="metric"><div class="label">Fakturowane <span title="Wyfakturowane liczone wg miesiąca rozliczenia zlecenia">ⓘ</span></div><div class="value num">${(stats.wyfakturowaneGodziny || 0).toFixed(1)} h</div></div>
